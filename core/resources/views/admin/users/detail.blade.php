                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($user->deposit_wallet) }}</h3>
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--18">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white">@lang('Pending Ticket')</p>
                        </div>
                        <a href="{{ route('admin.ticket.pending') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
