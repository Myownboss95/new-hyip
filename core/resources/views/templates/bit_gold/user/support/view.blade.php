                    ...
                    <div class="card-body">
                        @if($myTicket->status != 4)
                            <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="text-end">
                                    <a href="javascript:void(0)" class="btn--base btn-sm addFile"><i class="fa fa-plus"></i> @lang('Add New')</a>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn--base w-100"> <i class="fa fa-reply"></i> @lang('Reply')</button>
                            </form>
                        @endif
                    </div>
                </div>
